# Homework 2 - *I Len's Chat*

**I Len's Chat** is a Ruby on Rails blog application that allows users to send messages to each other that can only be read once.
...
![Video Walkthrough](https://github.com/ilentt/ilenchat/blob/master/demo/walkthrough.gif)
